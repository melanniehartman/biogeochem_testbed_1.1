...
# Read psyn.out file. Assign global data structures gppCrpData and gppForData.
...
ReadCORPSEresults = function ()
{
  ...
  { 
    ...
    RhCORPSEData[,colCnt] <<- dataCORPSE[,RhCol] * kg2g
    ...
    somscCORPSEData[,colCnt] <<- (dataCORPSE[,CsoilluCol]+dataCASA[,CsoilsuCol]+dataCASA[,CsoilduCol] 
                                + dataCORPSE[,CsoillpCol]+dataCASA[,CsoilspCol]+dataCASA[,CsoildpCol]) * kg2g
