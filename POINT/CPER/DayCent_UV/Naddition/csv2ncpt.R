...
workdir <<- "E:\\dev\\NCAR\\CASACLM\\POINT\\CPER\\DayCent_UV\\Naddition\\"
setwd(workdir)
...
inputCSVFileName = paste(workdir, "met_CPER_1912_2016_v3.csv", sep="")
outputNcFileName = paste(workdir, "met_CPER_1912_2016_v3.nc", sep="")
#inputCSVFileName = paste(workdir, "met_CPER_1912_1931_v3.csv", sep="")
#outputNcFileName = paste(workdir, "met_CPER_1912_1931_v3.nc", sep="")
