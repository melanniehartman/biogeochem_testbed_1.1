...
#      
# Description:
#   This R script will plot DayCent results from the CPER simulations
...
siteName <<- "sgs"
# Path to files
modelPath = "E:/dev/NCAR/CASACLM/POINT/CPER/DayCent_UV"
casaPath = "E:/dev/NCAR/CASACLM/POINT/CPER/CASACNP"
mimicsPath = "E:/dev/NCAR/CASACLM/POINT/CPER/MIMICS"
corpsePath = "E:/dev/NCAR/CASACLM/POINT/CPER/CORPSE"
setwd(modelPath)
...
ReadDataLis = function ()
{
    ...
    {
        somName <- paste(siteName, ".lis", sep="")
        lisFileName <<- paste(modelPath,mgmt,somName,sep="/")
        ...
        {        
            ...
            if (doAlloc == 1)
            {
                ...
                agcaccData <<- array(data = 0.0, dim = c(nTimes,nCols))
                bgcaccData <<- array(data = 0.0, dim = c(nTimes,nCols))
                ...
                agcaccData[,1] <<- dataLis[,timeCol]
                bgcaccData[,1] <<- dataLis[,timeCol]
            ...
            agcaccData[,colCnt] <<- dataLis[,agcaccCol] 
            bgcaccData[,colCnt] <<- dataLis[,bgcjaccCol] + dataLis[,bgcmaccCol]
...
ReadPsynOut = function ()
{
  ...
  for (mgmt in mgmtOptions)
  {
    psynFileName <- paste("psyn", ".out", sep="")
    psynFileName <- paste(modelPath,mgmt,psynFileName,sep="/")
...
ReadDailyOut = function ()
{
  ...
  for (mgmt in mgmtOptions)
  {
    dailyFileName <- paste("daily", ".out", sep="")
    dailyFileName <- paste(modelPath,mgmt,dailyFileName,sep="/")
...
Read_dcsipcsv = function ()
{
  ...
  for (mgmt in mgmtOptions)
  {
    dcsipFileName <- paste("dc_sip", ".csv", sep="")
    dcsipFileName <- paste(modelPath,mgmt,dcsipFileName ,sep="/")
...
PlotDataSOM = function ()
{
    ...
    plotTitle = "Short Grass Steppe: DayCent Total Soil C and Individual Pools"
    units = "gC/m2"
    PlotLayout()
...
#-------------------------------------------------------------------------------------------------
# Function PlotGrassNPP 

PlotGrassNPP = function ()
{
  ...
  plotTitle = "Short Grass Steppe: DayCent Annual NPP"
  units = "gC/m2/yr"
  PlotLayout()
  ...
  {
    colCnt <- colCnt + 1
    plot(agcaccData[,1],agcaccData[,colCnt],type="l",lwd=2,col=colvec,lty=1,main=plotTitle,sub=mgmt,xlab="",ylab=units,xlim=xrange,ylim=yrange)
    lines(bgcaccData[,1],bgcaccData[,colCnt],type="l",lwd=2,col=colvec[2])
  }
  legvals <<- c("agcacc","bgcacc")
  legend(x="top",y="bottom",lwd=2,col=colvec,lty=1,legend=legvals,ncol=1)
  
  #PlotLabels(plotTitle, units)
  
} # End function PlotGrassNPP()

#-------------------------------------------------------------------------------------------------
# Function PlotGrassGPP 

PlotGrassGPP = function (period)
{
  ...
  xrange <- c(startYr,endYr)
  PlotLayout()
  plotTitle = "Short Grass Steppe: DayCent GPP"
  ...
  for (mgmt in mgmtOptions)
  {
    ...
    if (period == "daily") 
    {
      plot(gppCrpData[,1],gppCrpData[,colCnt],type="l",lwd=2,col=colvec,lty=1,main=plotTitle,sub=mgmt,xlab="",ylab=units,xlim=xrange,ylim=yrange)
    }
    else
    {
      plot(gppCrpAnData[,1],gppCrpAnData[,colCnt],type="l",lwd=2,col=colvec,lty=1,main=plotTitle,sub=mgmt,xlab="",ylab=units,xlim=xrange,ylim=yrange)
    }
...
PlotCropShootC = function()
{
  ...
  plotTitle <- "Short Grass Steppe: Above Ground Live C"
  units = "gC/m2"
  PlotLayout()
  ...
  {
    colCnt <- colCnt + 1
    matplot(aglivcData[,1],aglivcData[,colCnt],type="l",lwd=2,col=colvec,lty=1,main=plotTitle,sub=mgmt,xlab="",ylab=units,xlim=xrange,ylim=yrange)
  }
  #PlotLabels(plotTitle, units)
...
PlotCropRootC = function()
{
  ...
  plotTitle <- "Short Grass Steppe: Total Live Root C"
  units = "gC/m2"
  PlotLayout()
  ...
  {
    colCnt <- colCnt + 1
    plot(bglivcData[,1],bglivcData[,colCnt],type="l",lwd=2,col=colvec,lty=1,main=plotTitle,sub=mgmt,xlab="",ylab=units,xlim=xrange,ylim=yrange)
  }
...
PlotForestNPP = function ()
{
  ...
  plotTitle = "Short Grass Steppe: DayCent Total Tree NPP by part"
  units = "gC/m2/yr"
  PlotLayout()
...
PlotForestGPP = function (period)
{
  ...
  xrange <- c(startYr,endYr)
  PlotLayout()
  plotTitle = "Short Grass Steppe: DayCent Forest GPP"
...
PlotForestC = function ()
{
  ...
  plotTitle = "Short Grass Steppe: DayCent Total Tree C and Individual Pools"
  units = "gC/m2"
  PlotLayout()
...
# Read POINT_casa_1_trans.csv and extract NPP, soil carbon, litter, fT, and fW.
# 
...
ReadCASAresults = function ()
{
  ...
  #casaFileName <- paste("POINT_casa_1_trans_wsat0.5", ".csv", sep="")
...
ReadMIMICSresults = function ()
{
  ...
  mimicsFileName <- paste("POINT_mimics_1_trans", ".csv", sep="")
  ...
  { 
    ...
    colCnt <- 2
    mgcm3togCm2 = 10*30 # convert mg C/cm3 to gC/m2 assuming depth of 30 cm
...
ReadCORPSEresults = function ()
{
  ...
  { 
    ...
    somscCORPSEData[,colCnt] <<- (dataCORPSE[,CsoilluCol]+dataCASA[,CsoilsuCol]+dataCASA[,CsoilduCol] 
                                + dataCORPSE[,CsoillpCol]+dataCASA[,CsoilspCol]+dataCASA[,CsoildpCol])
...
Plot_DC_CASA_GPP_NPP = function (period)
{
  ...
  if (period == "daily") 
  {
    plotTitle = "Short Grass Steppe: Daily GPP"
    plot(gppCrpData[,1],gppCrpData[,colCntDC],type="l",lwd=2,col=colvec[1],lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
    lines(gppCASAData[,1],gppCASAData[,colCntCASA],type="l",lwd=2,col=colvec[2])

    plotTitle = "Short Grass Steppe: Daily NPP"
    plot(nppCrpData[,1],nppCrpData[,colCntDC],type="l",lwd=2,col=colvec[1],lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
    lines(nppCASAData[,1],nppCASAData[,colCntCASA],type="l",lwd=2,col=colvec[2])

  } else {
    plotTitle = "Short Grass Steppe: Annual GPP"
    plot(gppCrpAnData[,1],gppCrpAnData[,colCntDC],type="b",lwd=2,col=colvec,lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
    lines(gppCASAAnData[,1],gppCASAAnData[,colCntCASA],type="b",lwd=2,col=colvec[2])

    plotTitle = "Short Grass Steppe: Annual NPP"
    plot(nppCrpAnData[,1],nppCrpAnData[,colCntDC],type="b",lwd=2,col=colvec[1],lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
...
Plot_DC_CASA_SOILC = function ()
{
  ...
  plotTitle = "Short Grass Steppe: Above+Below Ground Soil C and Individual Pools"
  units = "gC/m2"
  PlotLayout()
...
Plot_ALL_SOILC = function ()
{
  ...
  plotTitle = "SGS: Above+Below Ground Soil C"
  units = "gC/m2"
  PlotLayout4()
  ...
  subTitle = "Ground DayCent N-unlimited"
  plot(somscData[,1],somscData[,colCntDC]+som1c1Data[,colCntDC]+som2c1Data[,colCntDC],type="l",lwd=2,col=colvec[1],lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
  lines(som1c2Data[,1],som1c1Data[,colCntDC]+som1c2Data[,colCntDC],type="l",lwd=2,col=colvec[2])
  lines(som2c2Data[,1],som2c2Data[,colCntDC]+som2c2Data[,colCntDC],type="l",lwd=2,col=colvec[3])
  lines(som3cData[,1],som3cData[,colCntDC],type="l",lwd=2,col=colvec[4])
  ...
  subTitle = "MIMICS"
  #yrange <- c(0,max(somscMIMICSData[,colCntMIMICS]))
  ...
  subTitle = "CORPSE"
  #yrange <- c(0,max(somscCORPSEData[,colCntMIMICS]))
...
Plot_ALL_Rh = function ()
{
  ...
  plotTitle = "SGS: Heterotrophic Respiration"
  units = "gC/m2/day"
  PlotLayout4()
...
#-------------------------------------------------------------------------------------------------
# Function Plot_DC_CASA_MIMICS_LITC() 
# * Plot graphs of simulated litter (metabolic and structural C)
#   for DayCent, CASA, and MIMICS.
# * Set yrange if necessary to insure that all values show up in the graphs.

Plot_DC_CASA_MIMICS_LITC = function ()
{
  ...
  plotTitle = "Short Grass Steppe: Litter C Pools"
  units = "gC/m2"
  PlotLayout4()
  ...
  subTitle = "MIMICS C-only"
  yrange <- c(0,3000)
  plot(metMIMICSData[,1],metMIMICSData[,colCntMIMICS],type="l",lwd=2,col=colvec[1],lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
  lines(strucMIMICSData[,1],strucMIMICSData[,colCntMIMICS],type="l",lwd=2,col=colvec[2])
  
  plot(0,xlab="",ylab=units,xlim=xrange,ylim=yrange)
  legvals <<- c("metabolic","structural")
  legend(x="top",y="bottom",lwd=2,col=colvec,lty=1,legend=legvals,ncol=1)
  
  #PlotLabels(plotTitle, units)
  
} # End function Plot_DC_CASA_MIMICS_LITC()
...
Plot_DC_CASA_fT_fW = function ()
{
  ...
  plotTitle = "Short Grass Steppe: Soil temperature and moisture decomposition factors"
  units = "fraction"
  PlotLayout()
...
# Plot MIMICS and CORPSE microbial biomass 

Plot_Microb = function()
{
  par(mfrow=c(2,2))
  startYr <- 1912
  endYr <- 2016
  colvec <<- c("blue","darkgreen","green","brown")
  
  xrange <- c(startYr,endYr)
  
  yrange <- c(min(micrMIMICSData[,2])-1,max(micrMIMICSData[,2])+1)
  plotTitle = "SGS: microbial biomass"
  subTitle = "MIMICS Mic-r"
  units = "gC/m2"
  colCnt = 2
  plot(micrMIMICSData[,1],micrMIMICSData[,colCnt],type="l",lwd=2,col=colvec[1],lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
  #for (dP in 2:5)
  #{
  #  colCnt = colCnt + 1
  #  lines(micrMIMICSData[,1],micrMIMICSData[,colCnt],type="l",lwd=2,col=colvec[dP]) 
  #}
  
  yrange <- c(min(mickMIMICSData[,2])-1,max(mickMIMICSData[,2])+1)
  plotTitle = "SGS: microbial biomass"
  subTitle = "MIMICS Mic-k"
  units = "gC/m2"
  colCnt = 2
  plot(mickMIMICSData[,1],mickMIMICSData[,colCnt],type="l",lwd=2,col=colvec[1],lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
  #for (dP in 2:5)
  #{
  #  colCnt = colCnt + 1
  #  lines(mickMIMICSData[,1],mickMIMICSData[,colCnt],type="l",lwd=2,col=colvec[dP]) 
  #}
  
  yrange <- c(min(micCORPSEData[,2])-1,max(micCORPSEData[,2])+1)
  plotTitle = "SGS: microbial biomass"
  subTitle = "CORPSE Live Microbes"
  units = "gC/m2"
  colCnt = 2
  plot(micCORPSEData[,1],micCORPSEData[,colCnt],type="l",lwd=2,col=colvec[1],lty=1,main=plotTitle,sub=subTitle,xlab="",ylab=units,xlim=xrange,ylim=yrange)
  #for (dP in 2:5)
  #{
  #  colCnt = colCnt + 1
  #  lines(micCORPSEData[,1],micCORPSEData[,colCnt],type="l",lwd=2,col=colvec[dP]) 
  #}
  
  plot(0,xlim=xrange,ylim=yrange)
  legend(x="top",y="bottom",lwd=2,col=colvec,lty=1,legend=c("Microbial biomass C"),ncol=1)
  
  
} # End function Plot_Microb()
#-------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------
...
Read_dcsipcsv() # Read simulated NPP and Rh from the dc_sip.csv files
ReadDailyOut()  # Read simulated agdefac and bgdefac from daily.out

# DayCent State Variables
PlotDataSOM() 
PlotCropShootC()
PlotCropRootC()

# DayCent Fluxes
PlotGrassNPP() # annual only because it is plotting acc variables by part
PlotGrassGPP("daily")
PlotGrassGPP("annual")

# Read CASA, MIMICS, and CORPSE results
ReadCASAresults()
ReadMIMICSresults()
ReadCORPSEresults()

# Plot DayCent and CASA comparisons
Plot_DC_CASA_GPP_NPP("daily")
Plot_DC_CASA_GPP_NPP("annual")
Plot_DC_CASA_SOILC()
Plot_DC_CASA_MIMICS_LITC()
Plot_DC_CASA_fT_fW()  # Plot soil and temperature multipliers on decomposition rates

# Plot DayCent, CASA, MIMICS, CORPSE comparisons
Plot_ALL_SOILC()
Plot_ALL_Rh()

# Plot microbial biomass C for MIMICS and CORPSE
Plot_Microb()
