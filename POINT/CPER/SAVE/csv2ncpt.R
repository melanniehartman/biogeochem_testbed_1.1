...
inputCSVFileName = paste(workdir, "met_niwot_pt09862_1901_2010.csv", sep="")
outputNcFileName = paste(workdir, "met_niwot_pt09862_1901_2010.nc", sep="")
...
for (iyr in 1:maxYrs)
{
    for (idy in 1:365)
    {
        ...
        xtairk[dayCnt] = outputSummary[dayCnt,colInTair] + 273.15
