...
#workdir <<- "E:\\dev\\NCAR\\CASACLM\\POINT\\CPER\\DayCent_UV\\"
...
inputCSVFileName = paste(workdir, "met_HARVF_1992_2006.csv", sep="")
outputNcFileName = paste(workdir, "met_HARVF_1992_2006.nc", sep="")

#inputCSVFileName = paste(workdir, "met_HARVF_1900_2006.csv", sep="")
#outputNcFileName = paste(workdir, "met_HARVF_1900_2006.nc", sep="")
...
{
    # Quit if maxDays is not a multiple of 365
    # Check that day 366 has been removed from all leap years,
    # and that there are no empty lines of commas at the bottom of the .csv file.
    quit
}
