...
#         July 23, 2018
#         August 20, 2018
#         October 8, 2018 - add MIMICS and CORPSE
#      
# Description:
...
ReadMIMICSresults = function ()
{
  ...
  { 
    ...
    RhMIMICSData[,colCnt] <<- dataCASA[,RhCol]
    metMIMICSData[,colCnt] <<- dataCASA[,ClitMetCol]
    strucMIMICSData[,colCnt] <<- dataCASA[,ClitStrucCol]
    micrMIMICSData[,colCnt] <<- dataCASA[,CmicrCol] 
    mickMIMICSData[,colCnt] <<- dataCASA[,CmickCol] 
    somaMIMICSData[,colCnt] <<- dataCASA[,CsoilaCol] 
    somcMIMICSData[,colCnt] <<- dataCASA[,CsoilcCol] 
    sompMIMICSData[,colCnt] <<- dataCASA[,CsoilpCol]
    somscMIMICSData[,colCnt] <<- dataCASA[,CsoilaCol]+dataCASA[,CsoilcCol]+dataCASA[,CsoilpCol]
    
    #fTMIMICSData[,colCnt] <<- dataCASA[,fTCol] 
    #fWMIMICSData[,colCnt] <<- dataCASA[,fWCol]
