...
#     However, up to about 5 years can be written to a met*.nc file before it becomes too large.
...
#$histNcFile = "${inNcDir}clm4_5_12_r191_CLM45spHIST_CRU.clm2.h1.1850-01-01-00000.nc";
...
# Directory where surface data set is stored
#$surfDataNcFile = "${inNcDir3}surfdata_1.9x2.5_simyr1850_c130421_ADDwat4.nc";
#$inNcDir2 = "/project/tss/wwieder/CASACLM/";
#$surfDataNcFile = "${inNcDir3}surfdata_1.9x2.5_16pfts_Irrig_CMIP6_simyr1850_c170824.nc";
$inNcDir2 = "/project/tss/wwieder/CASACLM/clm_forcing/CLM5sp_GSWP3_hist/";
$surfDataNcFile = "${inNcDir2}CLM5sp_HIST_GSWP3.clm2.h0.1850-01.nc";

# Directory N deposition are stored
#$inNcDir3 = "/project/tss/wwieder/CASACLM/";
#$ndepNcFile = "${inNcDir3}fndep_clm_hist_simyr1849-2006_1.9x2.5_c100428.nc";
$inNcDir3 = "/project/tss/wwieder/CASACLM/NetCDFTools/";
$ndepNcFile = "${inNcDir3}fndep_clm_rcp8.5_simyr1849-2106_1.9x2.5_c100428.nc";

$filesin = "./files.ini";
$co2file = "./CO2_1768-2010.txt";
...
$outNcDir = "/project/tss/bgc01/melannie/CASACLM/GRID/INPUT_MET_GRID_GSWP3_CLM5";
